...
2.  El segundo es un método específico de Plone/Zope para cambios en las
    ...
    platillas y otros recursos, y es explicado con más :ref:`profundidad en la sección de capas Skin <5242_seccion>`
    en este manual.
...
-   Vaya a la ZMI (Interfaz de Administración de Zope) en :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope`
...
-   Vaya a la ZMI (Interfaz de Administración de Zope) en :menuselection:`Configuración de sitio --> Interfaz de Administración de Zope`
-   Asegúrese de haber cambiado su CSS Registry (Registro CSS) a modo depuración (:menuselection:`Configuración de sitio --> Interfaz de Administración de Zope --> portal_css`)
...
-   Vaya a portal_view_customizations en la ZMI (Interfaz de
    Administración de Zope) (:menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations`)
...
4.3.2.2. Huevos Python, Instalación Genérica y Zope 3
=====================================================
...
``accessor``El método accessor para el campo. Llámelo para recuperar el valor
...
5.2.1.7. Cómo personalizar las vista o edición sobre los elementos de contenidos en Arquetipos
==============================================================================================
...
las plantillas genéricas están almacenadas en plone_templates. Si desea
...
:menuselection:`Interfaz de Administración de Zope --> portal_skins --> custom`
  Ubicación para versiones locales personalizadas de los stylesheets encontrados en :menuselection:`Interfaz de Administración de Zope --> portal_skins --> plone_styles`.
...
Su interfaz de administrador de viewlet [su paquete de tema]/browser/interfaces.py directivas del archivo de configuración [su
...
+=========================================+============================+============================================================+=========================================+
|                                         | Enlaces para salto         | <p class="hiddenStructure"> ... </p>                       | `plone.skip_links`_ plone.portalheader     |
|                                         |                            |                                                            | `viewlet`_                                 |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         |  Título de Cabecera HTML   | <title> ...</title>                                        | `plone.htmlhead.title`_ plone.htmlhead     |
|                                         |  Título de Cabecera HTML   | <title> ...</title>                                        | `viewlet`_                                 |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         | Enlaces anterior/siguiente | <link title="Go to previous item" />                       | `plone.nextprevious.links`_                |
|                                         |                            |                                                            | plone.htmlhead.links `viewlet`_            |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         | Enlace Favicon             | <link rel="shortcut icon" />                               | `plone.links.favicon`_                     |
|                                         |                            |                                                            | plone.htmlhead.links `viewlet`_            |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         | Enlace de búsqueda         | <link rel="search" ... />                                  | `plone.links.search`_ plone.htmlhead.links |
|                                         |                            |                                                            | `viewlet`_                                 |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         | Enlace de autor            | <link rel="author" ... />                                  | `plone.links.author`_                      |
|                                         |                            |                                                            | plone.htmlhead.links `viewlet`_            |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         | Enlace de navegación       | <link title="Front Page" ...> and                          | `plone.links.navigation`_                  |
|                                         | Enlace de navegación       | <link title="Site Map"..>                                  | plone.htmlhead.links `viewlet`_            |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         | Analytics                  | (Fragmento de código definido por el administrador         | `plone.analytics`_ plone.portalfooter      |
|                                         |                            | del sitio)                                                 | `viewlet`_                                 |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
|                                         | Encabezado                 | <div id="portal-header"> ... </div>                        | `plone.header`_ plone.portaltop `viewlet`_                 |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
...
|                                         | Ariadna del portal)        |                                                            | plone.portaltop `viewlet`_                                 |
+------------------------------------------+---------------------------+------------------------------------------------------------+-----------------------------------------+
...
ClaveTítuloHTMLNombre del Tipo de Administrador
...
Enlace de búsqueda<link rel="search" ... />`plone.links.search`_
plone.htmlhead.links
`viewlet`_
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.header
...
Nombre de la plantilla: portal_header.pt

Nombre de la clase: none

Administrador: plone.portaltop (nombre)
...
Fragmento: ``<p class="hiddenStructure"> ...</p>``

CSS: invisibles.css

Nombre: plone.skip_links
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.skip_links
...
Nombre de la plantilla: skip_links.pt

Nombre de la clase: plone.app.layout.viewlets.common.SkipLinksViewlet

Administrador: plone.portalheader (nombre)
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.htmlhead.title
...
Nombre de la plantilla: none

Nombre de la clase: plone.app.layout.viewlets.common.TitleViewlet

Administrador: plone.htmlhead (nombre)
...
Nombre: plone.nextprevious.links
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.nextprevious.links
...
Nombre de la plantilla: links.pt

Nombre de la clase: plone.app.layout.nextprevious.view.NextPreviousLinksViewlet

Administrador: plone.htmlhead.links (nombre)
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.links.favicon
...
Nombre de la plantilla: favicon.pt

Nombre de la clase: plone.app.layout.links.viewlets.FaviconViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.links.search
...
Nombre de la plantilla: search.pt

Nombre de la clase: plone.app.layout.links.viewlets.SearchViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.links.author
...
Nombre de la plantilla: author.pt

Nombre de la clase: plone.app.layout.links.viewlets.AuthorViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.links.navigation
...
Nombre de la plantilla: navigation.pt

Nombre de la clase: plone.app.layout.links.viewlets.NavigationViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.analytics
...
Nombre de la clase: plone.app.layout.analytics.view
.AnalyticsViewlet

Administrador: plone.portalfooter (nombre)
...
Nombre: plone.htmlhead.dublincore
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.htmlhead.dublincore
...
Nombre de la clase:plone.app.layout.viewlets.common.DublinCoreViewlet
...
Nombre: plone.htmlhead.kss-base-url
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.htmlhead.kss-base-url
...
Nombre de la clase: plone.app.kss.headerViewlet.KSS
BaseUrlViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.links.RSS
...
Nombre de la plantilla: rsslink.pt

Nombre de la clase: plone.app.layout.links.viewlets.RSSViewlet
...
</ul>``Nombre: plone.app.i18n.locales.languageselector
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.app.i18n.locales.languageselector
...
Nombre de la plantilla: languageselector.pt

Nombre de la clase: plone.app.i18n.l
ocales.browser.selector.LanguageSelector

Administrador: Portal Top (name)
               plone.app.layout.viewlets.interfaces.IPortalTop (interfaz)
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.site_actions
...
Nombre de la plantilla: site_actions.pt

Nombre de la clase: plone.app.layout.viewlets.common.SiteActionsViewlet
...
Notas:Para personalizar el comportamiento del cuadro de búsqueda
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.searchbox 
...
Nombre de la plantilla: searchbox.pt

Nombre de la clase: plone.app.layout.viewlets.common.SearchBoxViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.logo
...
Nombre de la plantilla: logo.pt

Nombre de la clase: plone.app.layout.viewlets.common.LogoViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.global_sections
...
Nombre de la plantilla: sections.pt

Nombre de la clase: plone.app.layout.viewlets.common.GlobalSectionsViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.personal_bar
...
Nombre de la plantilla: personal_bar.pt

Nombre de la clase: plone.app.layout.viewlets.common.PersonalBarViewlet
...
Sunburst, el hilo de Ariadna ha sido diseñado para no aparecer hasta el
tercer nivel abajo. Personalice el CSS para cambiar este comportamiento.
CSS:public.css

Nombre: plone.path_bar
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.path_bar
...
Nombre de la plantilla: path_bar.pt

Nombre de la clase: plone.app.layout.viewlet
s.common.PathBarViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.contentviews
...
Nombre de la plantilla: contentviews.pt

Nombre de la clase: none

Administrador: plone.contentviews (nombre)
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.contentactions
...
la clase:plone.app.layout.viewlets.common.ContentActionsViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.tableofcontents
...
Nombre de la plantilla: toc.pt

Nombre de la clase: plone.app.layout.viewlets.common.TableOfContentsViewlet

Administrador: plone.abovecontentbody (nombre)
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.presentation
...
Nombre de la clase: plone.app.presentation.PresentationViewlet
...
Notas: Esto sólo aparecerá si algunas categorías han sido asignadas mediante :menuselection:`Edición --> Categorías` .

Fragmento: ``<div id="category" class="documentByLine">...</div>``

CSS:public.css

Nombre: plone.belowcontenttitle.keywords
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.belowcontenttitle.keywords
...
Nombre de la plantilla: keywords.pt

Nombre de la clase: none

Administrador: plone.belowcontenttitle (nombre)
...
Notas:Puede desactivar la línea de fondo para visitantes anónimos.
...
Nombre: plone.belowcontenttitle.documentbyline
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations`
 Ir a: plone.belowcontenttitle.documentbyline
...
Nombre de la plantilla: document_byline.pt

Nombre de la clase: plone.app.layout.viewlets.content.DocumentBylineViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.lockinfo
...
Nombre de la plantilla: info.pt

Nombre de la clase: plone.locking.browser.info.LockInfoViewlet

Administrador: plone.abovecontent (nombre)
...
Nombre: plone.belowcontentbody.workflowhistory
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.belowcontentbody.workflowhistory
...
Nombre de la plantilla: review_history.pt

Nombre de la clase: plone.app.layout.viewlets.content.WorkflowHistoryViewlet

Administrador: plone.belowcontentbody (nombre)
...
Nombre: plone.belowcontentbody.contenthistory
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.belowcontentbody.contenthistory
...
Nombre de la plantilla: content_history.pt

Nombre de la clase: plone.app.layout.viewlets.content.ContentHistoryViewlet
...
Nombre: plone.abovecontenttitle.documentactions
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.abovecontenttitle.documentactions
...
Nombre de la plantilla: document_actions.pt

Nombre de la clase: plone.app.layout.viewlets.content.DocumentActionsViewlet
...
Fragmento: ``<div class="relatedItems"> ... </div>``

CSS:public.
cssNombre: plone.belowcontentbody.relateditems
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.belowcontentbody.relateditems
...
Nombre de la plantilla: document_relateditems.pt

Nombre de la clase: plone.app.layout.viewlets.content.ContentRelatedItems
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.comments
...
Nombre de la plantilla: comments.pt

Nombre de la clase: plone.app.layout.viewlets.comments.CommentsViewlet

Administrador: plone.belowcontent (nombre)
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.nextprevious
...
Nombre de la plantilla: nextprevious.pt

Nombre de la clase: plone.app.layout.nex
tprevious.view.NextPreviousViewlet
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.footer
...
Nombre de la plantilla: footer.pt
Nombre de la clase:none
...
Uso: :menuselection:`Configuración del sitio --> Interfaz de Administración de Zope --> portal_view_customizations` Ir a: plone.colophon
...
Nombre de la plantilla: colophon.pt
Nombre de la clase:none
...
/profiles/default/viewlets.xml
  ...
  Utilice este archivo para ordenar sus viewlets dentro de los administradores 
  de viewlets /browser/configure.zcml Utilice este archivo para conectar los 
  componentes 
